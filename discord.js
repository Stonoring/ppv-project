...
// Clés API
const discordToken = process.env.DISCORD_TOKEN; // Récupération du token Discord à partir des variables d'environnement
const openaiApiKey = process.env.OPENAI_API_KEY; // Récupération de la clé API OpenAI à partir des variables d'environnement
